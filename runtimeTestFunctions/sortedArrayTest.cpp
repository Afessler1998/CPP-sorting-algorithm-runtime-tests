...
/*
this function creates a sorted array, then creates a copy for each sorting algorithm which will be tested.
...
void sortedArrayTest() {
  ...
  for (int i = 0; i < numOfTests; i++) {
    ...
    std::array<int, array_size> CycleSortArray = sortedArray;
  ...
  std::cout << "Sorted array results:" << std::endl << std::endl;
