...
/*
this function creates an almost sorted array, then creates a copy for each sorting algorithm which will be tested.
...
void almostSortedArrayTest() {
  ...
  for (int i = 0; i < numOfTests; i++) {
    ...
    std::array<int, array_size> CycleSortArray = almostSortedArray;
